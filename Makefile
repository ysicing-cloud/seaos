...
VERSION_PKG := github.com/linuxsuren/cobra-extension/version
ROOT_DIR := $(CURDIR)
...
LDFLAGS := "-w -s \
  ...
  -X 'k8s.io/client-go/pkg/version.buildDate=${BUILD_DATE}' \
	...
	-X 'k8s.io/client-go/pkg/version.gitMinor=25' \
  ...
  -X 'k8s.io/component-base/version.gitTreeState=dirty' \
	...
	-X 'k8s.io/component-base/version.gitMinor=25' \
...
build: ## build binary
	...
	@GO_ENABLED=1 gox -osarch="linux/amd64 darwin/arm64" \
